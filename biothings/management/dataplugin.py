...
def create_data_plugin(
    ...
    plugin_type: Optional[str] = typer.Option(  # NOQA: B008
        default="single,multiple",
        help="Data plugin type, values: single, multiple",
        prompt="Do you want to create a single or a multiple uploader?",
    ),
    ...
    parsed_template = (
        ...
        .generate(plugin_type=plugin_type, parallelizer=parallelizer)
        .decode()
    )
